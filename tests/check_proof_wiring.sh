...
require_text "SQLite archive rewrite guard"
require_text "SQLite lib symbol guard"
require_text "benchmark executable builds, benchmark parser guards, proof wiring, SQLite archive rewrite guard, SQLite lib symbol guard, bounded lock guard, and protected benchmark artifacts are clean"
