...
require_text "benchmark executable builds, benchmark parser guards, proof wiring, SQLite archive rewrite guard, bounded lock guard, and protected benchmark artifacts are clean"
